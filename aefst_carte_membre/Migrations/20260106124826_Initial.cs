        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    lieu_naissance = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "idx_membres_matricule",
                table: "membres",
                column: "matricule");

            migrationBuilder.CreateIndex(
                name: "idx_membres_nom",
                table: "membres",
                column: "nom");

            migrationBuilder.CreateIndex(
                name: "idx_membres_statut",
                table: "membres",
                column: "statut");

            migrationBuilder.CreateIndex(
                name: "IX_membres_user_id",
                table: "membres",
                column: "user_id");
